            ...
            >
              ...
              {isDropdownVisible && (
                <div
                  ...
                  } absolute z-10 w-48 top-4 -left-28 flex flex-col  text-sm`}
                >
                  <div className={`${bgColor ? 'text-[#777] bg-white' : 'text-[#D1D1D1] bg-gray-600'}  p-3 mt-3 shadow-lg`}>
                    { 
